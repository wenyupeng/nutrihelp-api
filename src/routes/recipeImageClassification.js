...
const predictionController = require('../controller/recipeImageClassificationController');
const { validateRecipeImageUpload } = require('./validators/recipeImageValidator');
